        ...
        else              //  not the first push operation and excess[node] is greater than 0
        {
          ...
          for (i=0; i<p.G[privQ.front()].size(); i++)   
           ...
           //   pthread_mutex_lock(&mutex);         //start of atomic part 
              ...
              //cout<<"push happening in "<<smallestHtVertex<<"\n";
...
cout<<"number of push operations "<<number_of_push_operations<<"\n";
cout<<"number of lift operations "<<number_of_lift_operations<<"\n";
