...
//  int wc=0;
  ...
  int number_of_times_agr_runs=0;
...
void *thread(void *tp)
{
  ...
  int trigger_count=0;            //used to trigger heuristics 
...
cout<<"\nNumber of times heuristics runs "<<number_of_times_agr_runs<<"\n";
cout<<"\n";
