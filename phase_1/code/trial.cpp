...
/*struct AtomicCounter {
    AtomicCap cap1;
    int from1, to1, flow1, index1;

    AtomicCounter(int from, int to, int cap , int flow, int index) :
       from1(from), to1(to), cap1(cap), flow1(flow), index1(index) {}
